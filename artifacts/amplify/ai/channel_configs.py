...
CHANNEL_CONFIGS = {
    ...
    "email_standalone_digest": {
        ...
        "format_rules": (
            ...
            "2. **Subtitle** on line 2 directly under the title (no blank line between them) — bolded with **...** (same emphasis as the title), one short line that reframes the title from the user's perspective (what they can now do or find). Subtitle must NOT be a definition or rephrase of the title.\n"
            "3. A blank line.\n"
