CHANNEL_CONFIGS = {
    ...
    "email_short": {
        ...
        "format_rules": "Structure: 'Subject: [compelling subject line]' on first line, blank line, then a SHORT intro header line (a catchy one-liner — must be DIFFERENT from the subject line), blank line, then 1-2 very short paragraphs (2-3 sentences total). First paragraph: what's new and why it matters to the user. Second paragraph (optional): single CTA sentence. No bullet points. No HTML. Keep it scannable on mobile — this is a quick update, not a deep dive. IMPORTANT: The subject line and the intro header must convey different angles.",
    ...
    "email_medium": {
        ...
        "max_chars": 1000,
        "tone": "Professional but warm. Benefit-led, second person. Room to paint the picture of the problem solved and highlight key use cases.",
        "format_rules": "Structure: 'Subject: [compelling subject line]' on first line, blank line, then a SHORT intro header line (a catchy one-liner — must be DIFFERENT from the subject line), blank line, then 2-3 short paragraphs with optional bullet points. First paragraph: hook with the user's pain point or aspiration. Second paragraph: what's new — use 2-4 bullet points to highlight key benefits or use cases. Third paragraph: CTA with specific next step. Keep paragraphs to 2-3 sentences each. No HTML. IMPORTANT: The subject line and the intro header must convey different angles.",
    ...
    "email_long": {
        ...
        "format_rules": "Structure: 'Subject: [compelling subject line]' on first line, blank line, then a SHORT intro header line (a catchy one-liner — must be DIFFERENT from the subject line), blank line, then 3-5 paragraphs with bullet points and detail. First paragraph: hook with pain point or industry context. Second paragraph: introduce the feature and its core benefit. Third paragraph: detailed breakdown with 3-5 bullet points covering specific capabilities, who benefits, and how. Fourth paragraph: real-world scenario or use case. Fifth paragraph: strong CTA. No HTML. IMPORTANT: The subject line and the intro header must convey different angles.",
